...
ggsave("XXX/Absolute_Volume_Exp6_CC3.tif", plot = my_plot, width = 10, height = 7, dpi = 300)
...
ggsave("XXX/Normalized_CC3.tif", plot = my_plot_normalized, width = 10, height = 7, dpi = 300)
