...
data1 <- read.table("C:/Users/SebastianBoehm/OneDrive/Dokumente/A_Kicheva/HM1/CC3/combined_data_Exp2.csv", header = TRUE, sep = ",")
data2 <- read.table("C:/Users/SebastianBoehm/OneDrive/Dokumente/A_Kicheva/HM1/CC3/combined_data_Exp3.csv", header = TRUE, sep = ",")
data3 <- read.table("C:/Users/SebastianBoehm/OneDrive/Dokumente/A_Kicheva/HM1/CC3/combined_data_Exp4.csv", header = TRUE, sep = ",")
data5 <- read.table("C:/Users/SebastianBoehm/OneDrive/Dokumente/A_Kicheva/HM1/CC3/combined_data_Exp6.csv", header = TRUE, sep = ",")
...
# Summary statistics for volume (mean and SD)
summary_stats_volume <- combined_data %>%
  group_by(Condition, time) %>%
  summarise(mean_value = mean(Volume, na.rm = TRUE),
            sd_value = sd(Volume, na.rm = TRUE),
            n = n())  # Calculate n for each group
...
ggsave("C:/Users/SebastianBoehm/Downloads/Absolute_Volume_Exp6_CC3.tif", plot = my_plot, width = 10, height = 7, dpi = 300)
...
ggsave("C:/Users/SebastianBoehm/Downloads/Normalized_CC3_exp6.tif", plot = my_plot_normalized, width = 10, height = 7, dpi = 300)


# Save the combined_data DataFrame as a CSV file
write.csv(combined_data, "C:/Users/SebastianBoehm/OneDrive/Dokumente/A_Kicheva/HM1/CC3/combined_data_pooled.csv", row.names = FALSE)
...
# Save the plot as a jpg file
ggsave("C:/Users/SebastianBoehm/Downloads/Absolute_CC3_Exp4_CC3_with_significance.tif", plot = my_plot, width = 10, height = 7, dpi = 300)
